...
# Gives potential information as to how much the person benched
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["acc_x"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["acc_y"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["acc_z"].plot()
plot_df[plot_df["set"] == plot_df["set"].unique()[0]]["acc_r"].plot()

# Gyroscope is not as helpful as accelerometer
...
# Heavy set so should be 5 repetitions
...
# Use MAE to calculate how off the scores were on average
error = mean_absolute_error(rep_df["reps"], rep_df["reps_pred"]).round(2)

# Overall error of 1 off
